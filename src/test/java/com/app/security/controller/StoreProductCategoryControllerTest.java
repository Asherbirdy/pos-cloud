...
public class StoreProductCategoryControllerTest extends AuthTestSupport {
    ...
    private static final String BASE_URL = "/store/" + STORE_ID + "/product-category";

    // ===== [GET] /store/{storeId}/product-category/ =====
    // 僅 STORE_MANAGER 可存取
     ...
     */
    @Test
    @DisplayName("admin (STORE_MANAGER) 登入 -> [GET] /store/{storeId}/product-category/ 應得 200")
     ...
     */
    @Test
    @DisplayName("user (STORE_STAFF) 登入 -> [GET] /store/{storeId}/product-category/ 應得 403")
    ...
    // ===== [GET] /store/{storeId}/product-category/{productCategoryId} =====
    // 僅 STORE_MANAGER 可存取
     ...
     */
    @Test
    @DisplayName("admin (STORE_MANAGER) 登入 -> [GET] /store/{storeId}/product-category/{id} 應通過權限 (非 403)")
     ...
     */
    @Test
    @DisplayName("user (STORE_STAFF) 登入 -> [GET] /store/{storeId}/product-category/{id} 應得 403")
    ...
    // ===== [POST] /store/{storeId}/product-category/ =====
    // 僅 STORE_MANAGER 可存取
     ...
     */
    @Test
    @DisplayName("admin (STORE_MANAGER) 登入 -> [POST] /store/{storeId}/product-category/ 應得 201")
     ...
     */
    @Test
    @DisplayName("user (STORE_STAFF) 登入 -> [POST] /store/{storeId}/product-category/ 應得 403")
    ...
    // ===== [PATCH] /store/{storeId}/product-category/{productCategoryId} =====
    // 僅 STORE_MANAGER 可存取
     ...
     */
    @Test
    @DisplayName("admin (STORE_MANAGER) 登入 -> [PATCH] /store/{storeId}/product-category/{id} 應通過權限 (非 403)")
     ...
     */
    @Test
    @DisplayName("user (STORE_STAFF) 登入 -> [PATCH] /store/{storeId}/product-category/{id} 應得 403")
    ...
    // ===== [DELETE] /store/{storeId}/product-category/{productCategoryId} =====
    // 僅 STORE_MANAGER 可存取
     ...
     */
    @Test
    @DisplayName("admin (STORE_MANAGER) 登入 -> [DELETE] /store/{storeId}/product-category/{id} 應通過權限 (非 403)")
     ...
     */
    @Test
    @DisplayName("user (STORE_STAFF) 登入 -> [DELETE] /store/{storeId}/product-category/{id} 應得 403")
